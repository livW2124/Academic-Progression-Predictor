...
while True:                                   #starting the looping process
    ...
    while condition:
        ...
        if tot_credits != 120:
            ...
            if pass_credits == 120:                   
                ...
                break                                                                                     #formatting and appending user inputs to the respective lists
            elif 0 <= pass_credits <= 80 and 0 <= defer_credits <= 120 and 0 <= fail_credits <= 60:       #incrementing  the counter variables
    ...
    while condition:
        ...
        user_option = input("Enter 'y' for yes or 'q' to quit and view results:\n")                #asking the user whether to quit using q or continue the programme using y
